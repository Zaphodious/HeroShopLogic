...
/**
 * ItemDrop contains information regarding the drop rate and quantity to drop for the Item class object contained within.
...
public final class ItemDrop {
    ...
    /**
     * By default, the amount of items to be dropped by each ItemDrop object will be 1. If a great number is desired, a Dice enum object can be passed in, to be used to determine the number of items to be dropped.
     * @param rollToDrop
     * @return
     */
     ...
     * @return An int representing how many items were dropped by this Object. If setAmountToDrop was called previously, returns a value between 1 and the number of sides the Dice object has.
     */
     ...
     * @param itemToDrop The item that is to be dropped by this Object.
     * @param chanceToDrop The chance between 1 (absurdly rare) and 100 (guaranteed to drop) for the item to drop.
